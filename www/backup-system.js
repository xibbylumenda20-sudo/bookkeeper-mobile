...
const { BookkeeperEngine } = typeof module !== 'undefined' && module.exports ? require('./accounting-engine.js') : window;
...
if (typeof window !== 'undefined') window.BackupSystem = BackupSystem;
})();
